...
<img src="./image/${item.imgSrc}" alt="">
<div class="more__about">
  <h1 class="bookName">${item.title}</h1>
  <p class="autherName">نویسنده: ${item.author}</p>
  <p class="date">سال انتشار: ${item.published_date}</p>
  <p class="lang"> زبان: ${item.language}</p>
  <p class="genre">ژانر: ${item.genre}</p>
  <h3>درباره کتاب</h3>
  <p class="summary">${item.about}</p>
...
function render(data) {
  ...
  let template = data.map((book) => {
    ...
    <div class="about">
        <div><h2 class="title">${book.title}</h2>
